  ...
  return (
      <section class="game-section" >
        <h5>
          ...
          <WiDirectionLeft className="icons" />
          <BsArrowDownShort className="icons" />
        ...
        <div class="Container" >
          ...
          <div className="keys">
            <a className="up arr" onClick={Snake.action('up')}>
              <WiDirectionUp className="chevron up" />
            </a>
            <br />
            <a className="left arr" onClick={Snake.action('left')}>
              <WiDirectionLeft className="chevron left" />
            </a>
            <a className="down arr"
            onClick={Snake.action('down')}>
              <BsArrowDownShort className="chevron down" />
            </a>
            <a className="right arr"
            onClick={Snake.action('right')}
            >
              <TbArrowNarrowRight className="chevron right" />
            </a>
          </div>
        </div>
      </section>
